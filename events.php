  ...
  <div class="site-wrap">
    ...
    <div class="site-section block-14">
      ...
      <div class="container">
        ...
        <div class="grid nonloop-block-14 owl-carousel">
            
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="media-with-text">
                  <div class="img-border-sm">
                    <a href="#">
                      <img src="images/@30_5.jpg" alt="" class="img-fluid">
                    </a>
                  </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="media-with-text">
                  <div class="img-border-sm">
                    <a href="#">
                      <img src="images/@30_8.jpg" alt="" class="img-fluid">
                    </a>
                  </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="media-with-text">
                  <div class="img-border-sm">
                    <a href="#">
                      <img src="images/@30_1.jpg" alt="" class="img-fluid">
                    </a>
                  </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="media-with-text">
                  <div class="img-border-sm">
                    <a href="#">
                      <img src="images/@30_22.jpg" alt="" class="img-fluid">
                    </a>
                  </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                <div class="media-with-text">
                  <div class="img-border-sm">
                    <a href="#">
                      <img src="images/@30_7.jpg" alt="" class="img-fluid">
                    </a>
                  </div>
                </div>
            </div>
